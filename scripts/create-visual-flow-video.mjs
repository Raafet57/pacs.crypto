...
It keeps return and reversal tied to the instruction lifecycle, not a separate normative API expansion.
...
The PR stays draft; the question for Tom is whether this makes the spec discussion easier.`;
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .node span.micro { margin-top: 8px; font-size: 15px; line-height: 1.15; }
...
<div id="stage" data-composition-id="root" data-start="0" data-duration="${duration}" data-width="${width}" data-height="${height}">
  ...
  <section id="scene-1" class="clip scene" data-start="${starts[0]}" data-duration="${sceneDur}" data-track-index="1">
    ...
    <div class="pillrow">
      ...
      <div class="pill amber">pacs.004 / pacs.007</div>
      <div class="pill rose">E&amp;I draft</div>
    </div>
    <div class="subtitle">Draft PR visual reference: clarify lifecycle, do not expand normative scope.</div>
  </section>
  ...
  <section id="scene-4" class="clip scene" data-start="${starts[3]}" data-duration="${sceneDur}" data-track-index="1">
    ...
    <div class="map">
      ...
      <div class="node n7" style="width:360px;height:132px"><b>Return request</b><span class="micro">POST /instruction/{instructionId}/return</span></div>
      <div class="node n5" style="left:1120px;width:430px;height:142px"><b>Reversal status</b><span class="micro">POST /instruction/{instructionId}/reverse</span><span class="micro">GET /instruction/{instructionId}/reversal-status</span></div>
...
async function main() {
  ...
  const renderOutput = withNarration
    ? 'videos/visual-flow-map-narrated/renders/pacs-crypto-visual-flow-tom-preview-narrated.mp4'
    : 'videos/visual-flow-map/renders/pacs-crypto-visual-flow-tom-preview.mp4';
